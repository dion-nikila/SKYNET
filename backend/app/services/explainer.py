...
HUMAN_MAP = {
    ...
    "wind_speed_lag1": "recent wind speed from one hour ago is associated with immediate dispersion behavior",
    "wind_speed_roll3": "short-term wind speed average is associated with local ventilation conditions",
    "wind_speed_roll24": "day-scale wind regime is associated with pollutant dispersion potential",
    "temperature": "temperature patterns are associated with mixing conditions",
    "temperature_lag1": "recent temperature from one hour ago is associated with near-term thermal conditions",
    "humidity": "humidity patterns are associated with particle suspension behavior",
    "humidity_lag1": "recent humidity from one hour ago is associated with next-hour conditions",
    "humidity_roll3": "short-term humidity average is associated with near-surface mixing behavior",
    "humidity_roll24": "day-scale humidity conditions are associated with particle behavior",
    "pressure_lag1": "recent pressure from one hour ago is associated with next-hour stability",
    "pressure_roll3": "short-term pressure average contributes to atmospheric stability context",
    "pressure_roll24": "day-scale pressure regime contributes to background stability context",
    "PM10": "coarse particles and dust levels are associated with PM2.5 dynamics",
    "PM10_lag1": "recent PM10 from one hour ago contributes to near-term particulate context",
    "PM10_lag3": "PM10 from a few hours earlier contributes to the current forecast signal",
    "PM10_roll3": "short-term PM10 average is associated with near-term PM2.5 behavior",
    "PM10_roll24": "daily PM10 average is associated with PM2.5 background pressure",
    ...
    "int_windspeedlag1_pm10lag1": "combined recent wind and PM10 pattern is associated with short-term particle dynamics",
    "int_humiditylag1_temperaturelag1": "combined recent humidity and temperature pattern is associated with near-term aerosol behavior",
    "int_pressurelag1_windspeedlag1": "combined recent pressure and wind pattern is associated with local dispersion/stability balance",
...
FEATURE_LABELS = {
    ...
    "temperature_lag1": "Temperature one hour ago",
